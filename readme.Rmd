...
train <- read_csv("./Data/train.csv", col_types = "nffcfnffcnff")
test <- read_csv("./Data/test.csv", col_types = "nffcfnffcnff")
```
...
### Numeric variables
```{r}
plot_vars <- function(variables, geom) {
  
  numeric_plots <- list()
  
  # add fill and geom selection based on column type
  ...
  do.call(grid.arrange, c(numeric_plots, ncol = 1))
...
plot_vars(dub_vars, geom_histogram)
plot_vars()
```
